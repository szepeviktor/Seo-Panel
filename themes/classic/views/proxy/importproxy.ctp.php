...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
	<tr class="listHead">
		<td class="left" width='30%'><?=$spTextPanel['Import Proxy']?></td>
		<td class="right">&nbsp;</td>
	</tr>
	<tr class="white_row">
		...
		<td class="td_right_col">
			...
			<p style="font-size: 12px;"><?=$spTextProxy['enterproxynote']?></p>
			<p><b><?=$spText['label']["Syntax"]?>:</b></p>
			<P><?=$spTextProxy['proxysyntax']?></P>
			<p><b>Eg:</b></p>
