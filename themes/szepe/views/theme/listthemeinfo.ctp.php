...
<div>&nbsp;<a href="javascript:void(0)" onclick="scriptDoLoad('themes-manager.php?pageno=<?=$pageNo?>', 'content')" class="back">&#171&#171 Back</a></div>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
	...
	<tr class="white_row">
		<td class="td_left_col bold"><?=$spText['label']['Theme']?>:</td>
